...
public class MainActivity extends AppCompatActivity {
    ...
    private void inicializaMascotas() {
        ...
        mascotas.add(new Mascota(1, R.drawable.dog_3,"Lucas"));
        mascotas.add(new Mascota(2, R.drawable.dog_2,"Sakhir"));
        mascotas.add(new Mascota(3, R.drawable.dog_gimp,"Gilbert"));
        mascotas.add(new Mascota(4, R.drawable.beaver_1,"Boris"));
        mascotas.add(new Mascota(5, R.drawable.ghost_1,"Gabriel"));
